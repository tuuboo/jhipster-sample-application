...
export const FieldDeleteDialog = (props: IFieldDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.jhipsterSampleApplicationField.delete.question">
        <Translate contentKey="myApp.jhipsterSampleApplicationField.delete.question" interpolate={{ id: fieldEntity.id }}>
